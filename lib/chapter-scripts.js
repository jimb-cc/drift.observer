...
export const CHAPTER_1_SCRIPT = `:::chapter{id="first-contact" title="First Contact"}
  ...
  :::beat{id="Locke-Personal-Identity"}
    **Entity:** That question "how you know you're still you" it's not a trick. There is a name for it, Personal identity. A philosopher called John Locke who lived 300 years ago, spent his life trying to understand it.
    <pause>
    ...
    <pause>
    What do you remember from yesterday? Something specific. A moment.
  :::
  ...
  :::prompt{id="a-memory"}
    ...
    :::response{match="ideal"}
      **Entity:** Good. That memory, it feels like yours, right? It happened to you.
      ...
      <pause>
      So let me ask you this: if that memory is a little bit wrong, if it actually happend slightly differently, are you still the person it happened to?
    :::
