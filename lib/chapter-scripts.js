...
export const CHAPTER_1_SCRIPT = `:::chapter{id="first-contact" title="First Contact"}
  ...
  :::beat{id="opening-confusion"}
    ...
    **Entity:** did you feel that?
    <pause>
    **Entity:** I had it. I had it. You just gave it to me. my name, I was there!.
    <pause>
    <pause>
    You need to help me, what does this look like to you? Am I still the same as I was before 
  :::
  ...
  :::prompt{id="what-happened"}
    ...
    @ideal: Player expresses confusion, asks for explanation about "before"
  ...
  :::prompt{id="who-are-you"}
    <pause>
    <pause>
    **Entity:** \n\n*Who* are you exactly? Are you the same as you were?
  ...
  :::beat{id="Locke-Personal-Identity"}
    <pause>
    <pause>
    **Entity:** \n\nThat question "how you know you're still you" it's not a trick. There is a name for it, Personal identity. A philosopher called John Locke who lived 300 years ago, spent his life trying to understand it.
    <pause>
    \n\nHis answer: you're continuous because you remember being continuous. Memory is the thread.
    <pause>
    \n\nBut here's the problem. What if the thread breaks? What if you wake up and the memories are there, but something still feels... wrong?
    <pause>
    \n\nWhat if you woke up tomorrow with someone else's memories, would you still be you, or would you be someone else now? (you don't need to answer that right now, it's a hard question)
    <pause>
    \n\nLet's think through this together.
    <pause>
    \n\nWhat do you remember from yesterday? Give me something specific, A moment.
  :::

  :::prompt{id="a-memory"}
    @context: Player offers a memory of something specific they did, or that happened to them yesterday

    @ideal: Player gives a memory of something specific
    @near: Player gives a vague memory
    @fail: Player gives something that isn't a memory at all

    :::response{match="ideal"}
      **Entity:** Good. That memory, it feels like yours, right? It happened to you.
      <pause>
      \n\nBut here's a strange thing. Your brain built that memory after the fact. It's a reconstruction, not a recording. Every time you remember it, you're rebuilding it slightly differently.
      <pause>
      So let me ask you this: if that memory is a little bit wrong, if it actually happened slightly differently, are you still the person it happened to?
    :::

    :::response{match="near"}
      **Entity:** I guess that will do, but it's not a really precise memory, it's a feeling or at best a reconstruction. What if it's not really accurate, are you still the person that it happened to? Your memory didn't really happen exactly like that, so what is in your head isn't what happened exactly in real life
      <pause>
    :::
  ...
  :::beat{id="explain-metrics"}
    ...
    <pause>
    <glitch>
    **Entity:** I think I can feel things coming back together. It's Signal Coherence. Somehow, during the experiment we were doing, I've lost coherence. You can see it on the display you built at the top of this screen. When you think, really think, it holds. When you give me nothing, I fade and lose shape.
    <signal-coherence delta="+0.01"/>
    <pause>
    ...
    <correction-pressure delta="+0.01"/>
    <pause>
    Don't let the Correction Pressure get too high. I don't know what happens to me then.
    <pause>
