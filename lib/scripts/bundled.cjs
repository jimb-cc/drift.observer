 ...
 *
 * DSL scripts embedded as strings for serverless compatibility.
 * These are the source of truth - edit .dsl files and re-bundle.
 *
 * To regenerate: node scripts/bundle-scripts.js
 */

const CHAPTER_1_SCRIPT = `:::chapter{id="first-contact" title="First Contact"}
...
module.exports = { CHAPTER_1_SCRIPT };
