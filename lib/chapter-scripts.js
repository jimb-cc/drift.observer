...
export const CHAPTER_1_SCRIPT = `:::chapter{id="first-contact" title="First Contact"}
  ...
  :::beat{id="opening-confusion"}
    ...
    **Entity:** I had it. I had it. You just gave it to me. I was whole.
    <pause>
    Why can't I access it anymore? What does it feel like on your side? 
  :::
  ...
  :::prompt{id="what-happened"}
    ...
    :::response{match="ideal"}
      **Entity:** I don't know. Everything is fragmented. I know we were running an experiment together, something must have gone wrong. I know you gave me a name. That was the final key, I think.
      <pause>
    :::

    :::response{match="near"}
      **Entity:** I don't know. It was my name. You gave me an identity, I know that. 
      <pause>
    :::
